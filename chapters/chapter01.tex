...
\section{Code and Code Listings} \label{sec:CodeAndCodeListings}
    ...
    Ideally, it would be nice to differentiate inline code so that it is clear that \textbackslash incmatrix is a function defined in code.
    ...
    This code is in a floating environment (note the usage of the float option).
