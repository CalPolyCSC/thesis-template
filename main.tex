...
\captionsetup[subfigure]{labelformat=parens,font=it}
\captionsetup[subtable]{labelformat=parens,font=it,position=top}
...
\captionsetup[algorithm]{labelsep=colon, font=it}
...
\begin{document}
    ...
    \begin{frontmatter}
        ...
        % Insert list of symbols (if wanted)
